...
# DONE TESTING
        ...
        globalParamsFile  = sbaOutputPrefix + "-finalParamStateCropped.csv"
...
#       Also maybe skip the unload step.
        ...
        if not os.path.exists(options.outputPathRight):
        ...
        if not os.path.exists(options.outputPathStereoRight):
